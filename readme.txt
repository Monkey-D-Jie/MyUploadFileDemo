尊重知识产权，人人有责！
以下是项目搭建过程参考的帖子出处，请各位看官明晰：
-----------分----割----线-----------------------
1.SpringMVC MultipartFile 异步批量上传文件 - CSDN博客
  https://blog.csdn.net/qingtianlong97/article/details/79023696
  
2.gradle更全面的编译配置请见：build_refrence.gradle
